...
```{r secret_load, eval=TRUE, echo=FALSE,message=FALSE,warning=FALSE}
devtools::install_github("tuomaseerola/onsetsync@R1",force = TRUE,quiet=TRUE)
library(onsetsync)
...
```{r availability,eval=FALSE,message=FALSE,warning=FALSE}
library(devtools)

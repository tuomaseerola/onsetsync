...
- [Tutorial in Rmarkdown](https://github.com/tuomaseerola/onsetsync/blob/master/onsetsync.Rmd) which requires you to run the code in RStudio.

- [Tutorial as Jupyter notebook](https://github.com/tuomaseerola/onsetsync/blob/master/onsetsync.ipynb) which allows you to run the code in Colab (in your browser).
